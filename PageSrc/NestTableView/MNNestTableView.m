...
@interface MNNestTableView () <UITableViewDelegate, UITableViewDataSource, UIGestureRecognizerDelegate>

@property (nonatomic, strong) MNAllowGestureEventPassTableView *tableView;

@property (nonatomic, assign) BOOL isFooterViewHidden;

@end

@implementation MNNestTableView
...
- (void)setDataSource:(id<MNNestTableViewDataSource>)dataSource {
...
- (void)commomInit {
    ...
    MNAllowGestureEventPassTableView *tableView = [[MNAllowGestureEventPassTableView alloc] initWithFrame:self.bounds];
