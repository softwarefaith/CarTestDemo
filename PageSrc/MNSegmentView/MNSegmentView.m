...
static NSString * const kMNSegmentViewReuseIdentifier = @"MNSegmentViewReuseIdentifier";

@interface MNSegmentView () <UICollectionViewDelegate, UICollectionViewDataSource>
...
- (void)commonInit {
    ...
    [_collectionView registerClass:[MNSegmentViewCell class] forCellWithReuseIdentifier:kMNSegmentViewReuseIdentifier];
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    MNSegmentViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:kMNSegmentViewReuseIdentifier forIndexPath:indexPath];
